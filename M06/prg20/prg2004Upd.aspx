<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="prg2004Upd.aspx.cs" Inherits="prg2004Upd" %>
    ...
    <article>
        ...
        <div class="page-body prg-content">
            ...
            <div style="border-top:2px #080 dotted;padding-top:15px;text-align:center;margin-top:30px;">
                ...
                <button class="btn-submit btn-page btn-admin" id="btn-submit" data-alt="emp-upd-main"><i class="fas fa-arrow-alt-circle-right"></i> 確定送出</button>
            </div>
        </div>
    </article>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <script>
        ...
        function Initial() {
            $(".emp-upd-main").find(":input").attr("disabled", true);
        ...
        $(function () {
            ...
            $("#btn-upd").click(function () {
                $(".emp-upd-main").find(":input").attr("disabled", false);
                $(this).hide();
            ...
            $("#btn-submit").click(function () {
                ...
                if (ChkFinish(id)) {
                    var $obj = $("." + id);
                    var data = "args0=C08A&" + $obj.find(":input").serialize();
                    $.ajax({
                        url: "/AjaxMain.aspx",
                        type: "POST",
                        async: false,
