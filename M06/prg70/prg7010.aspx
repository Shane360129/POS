<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="prg7010.aspx.cs" Inherits="prg7010" %>
        ...
        function CalcTotal() {
            ...
            kindAry.forEach(function (value) {
                ...
                $this.each(function () {
                    ...
                    amtTotal += parseFloat($(this).attr("data-val"));
                });
                $obj.find("." + value + "_total").attr("data-val", amtTotal).text(to3dot(amtTotal.toFixed(4)));
        ...
        function DownloadFile() {
            $.ajax({
                ...
                success: function (r) {
                    ...
                    if (isIE) {
                        window.navigator.msSaveBlob(blob, "7010貨品倉庫庫存報表.xlsx");
                    } else {
                        var url = window.URL || window.webkitURL;
                        link = url.createObjectURL(blob);
                        var a = $("<a />");
                        a.attr("download", "7010貨品倉庫庫存報表.xlsx");
                        a.attr("href", link);
                        $("body").append(a);
                        a[0].click();
                        $("body").remove(a);
