<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="prg7011.aspx.cs" Inherits="prg7011" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <script>
        ...
        function CalcTotal() {
            var amtTotal;
            var kindAry = new Array("Beginning_qty", "Beginning_Cost", "in_inQty", "in_inCost", "in_outQty", "in_outCost"
                , "out_outQty", "out_outCost", "out_inQty", "out_inCost", "Finally_Qty", "Finally_Cost", "oStkAmt", "oProfit");
            var $obj = $(".list-main")
    ...
    function DownloadFile() {
        $.ajax({
            ...
            success: function (r) {
                ...
                if (isIE) {
                    window.navigator.msSaveBlob(blob, "7011門市營業彙總表.xlsx");
                } else {
                    var url = window.URL || window.webkitURL;
                    link = url.createObjectURL(blob);
                    var a = $("<a />");
                    a.attr("download", "7011門市營業彙總表.xlsx");
                    a.attr("href", link);
                    $("body").append(a);
                    a[0].click();
                    $("body").remove(a);
