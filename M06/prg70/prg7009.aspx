<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="prg7009.aspx.cs" Inherits="prg7009" %>
                ...
                function DownloadFile() {
                    $.ajax({
                        ...
                        success: function (r) {
                            ...
                            if (isIE) {
                                window.navigator.msSaveBlob(blob, "7009銷貨統計表.xlsx");
                            } else {
                                var url = window.URL || window.webkitURL;
                                link = url.createObjectURL(blob);
                                var a = $("<a />");
                                a.attr("download", "7009銷貨統計表.xlsx");
                                a.attr("href", link);
                                $("body").append(a);
                                a[0].click();
                                $("body").remove(a);
