<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="prg7008.aspx.cs" Inherits="prg7008" %>
            ...
            function DownloadFile() {
                $.ajax({
                    ...
                    success: function (r) {
                        ...
                        if (isIE) {
                            window.navigator.msSaveBlob(blob, "7008進貨統計表.xlsx");
                        } else {
                            var url = window.URL || window.webkitURL;
                            link = url.createObjectURL(blob);
                            var a = $("<a />");
                            a.attr("download", "7008進貨統計表.xlsx");
                            a.attr("href", link);
                            $("body").append(a);
                            a[0].click();
                            $("body").remove(a);
